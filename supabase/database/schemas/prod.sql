...
CREATE TABLE IF NOT EXISTS "public"."MatchDataUploaded" (
    "id" bigint NOT NULL,
    "prematch_team_number" "text",
    "auto_coral" smallint NOT NULL,
    "auto_leave" smallint,
...
ALTER TABLE "public"."MatchDataUploaded" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."MatchDataUploaded_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."MatchDataUploaded"
    ADD CONSTRAINT "MatchDataUploaded_pkey" PRIMARY KEY ("key");
